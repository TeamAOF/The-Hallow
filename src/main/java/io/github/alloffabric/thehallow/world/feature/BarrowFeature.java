...
import io.github.alloffabric.thehallow.util.noise.OctaveOpenSimplexNoise;
...
public class BarrowFeature extends Feature<DefaultFeatureConfig> implements FeatureUtils {
	...
	private static final BlockState STONE = HallowedBlocks.TAINTED_STONE.getDefaultState();
	private static final BlockState AIR = Blocks.AIR.getDefaultState();

	// TODO Actual Barrow Wights
	private static final EntityType<?> BARROW_WIGHT = EntityType.SKELETON;

	private static final Identifier LOOT_TABLE = TheHallow.id("chests/barrow");
	...
	private interface CoordinateFunction<T> {
		T get(BlockPos pos);
	}
