...
import io.github.alloffabric.thehallow.block.TinyPumpkinBlock;
...
public class WitchWellFeature extends Feature<DefaultFeatureConfig> {
	private static final BlockStatePredicate CAN_GENERATE = BlockStatePredicate.forBlock(HallowedBlocks.DECEASED_GRASS_BLOCK);
	...
	private BlockState getPumpkin(Direction facing) {
		return HallowedBlocks.TINY_PUMPKIN.getDefaultState().with(TinyPumpkinBlock.FACING, facing);
	}
